...
**Importante — nombre de proyecto Docker Compose:** todos los scripts usan `-p mi_tienda_militar`. Al correr comandos manualmente, incluir siempre este flag:
```bash
docker compose -p mi_tienda_militar -f docker-compose.yml -f docker-compose.dev.yml <comando>
```
